...
(function (global, doc, ibexa, Translator, moment) {
  ...
  var SIMPLIFIED_MESSAGE_TIMEOUT = 3000;
  ...
  if (isAutosaveEnabled()) {
    ...
    var simplifiedMessageTimeoutId = null;
    ...
    var setDraftSavedMessage = function setDraftSavedMessage() {
      ...
      var saveMessage = Translator.trans(
      /*@Desc("Draft saved %time%")*/
    ...
    var setDelayedDraftSavedSimplifiedMessage = function setDelayedDraftSavedSimplifiedMessage() {
      simplifiedMessageTimeoutId = setTimeout(function () {
        var savedMessage = Translator.trans(
        /*@Desc("Saved")*/
        'content_edit.autosave.status_saved.message.simplified', {}, 'content');
      ...
      value: function loadDroppedFilePreview(event) {
        ...
        this.getImageUrl(files[0], function (url) {
          ...
          image.onload = function () {
            ...
            /* @Desc("W:%width% px") */
            'ezimage.dimensions.width', {
              width: width
            }, 'fieldtypes_edit');
            heightNode.innerHTML = Translator.trans(
            /* @Desc("H:%height% px") */
            'ezimage.dimensions.height', {
              height: height
            }, 'fieldtypes_edit');
          };
