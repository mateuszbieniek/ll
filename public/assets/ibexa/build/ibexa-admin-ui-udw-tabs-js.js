...
var Dropdown = function Dropdown(_ref) {
  ...
  var renderItemsList = function renderItemsList() {
    var itemsStyles = {};
    var placeholder = Translator.trans(
    /*@Desc("Search...")*/
    'dropdown.placeholder', {}, 'universal_discovery_widget');
...
var ActionsMenu = function ActionsMenu() {
  ...
  /*@Desc("Confirm")*/
  'actions_menu.confirm', {}, 'universal_discovery_widget');
  var cancelLabel = Translator.trans(
  /*@Desc("Cancel")*/
  'actions_menu.cancel', {}, 'universal_discovery_widget');
...
var ContentCreateWidget = function ContentCreateWidget() {
  ...
  var placeholder = Translator.trans(
  /*@Desc("Type to refine")*/
  'content_create.placeholder', {}, 'universal_discovery_widget');
  var filtersDescLabel = Translator.trans(
  /*@Desc("Or choose from list")*/
  'content.create.filters.desc', {}, 'universal_discovery_widget');
  var createUnderLabel = Translator.trans(
  /*@Desc("under %content_name%")*/
  'content.create.editing_details', {
...
var Filters = function Filters(_ref) {
  ...
  var renderSelectContentButton = function renderSelectContentButton() {
    ...
    /*@Desc("Select content")*/
    'filters.tag_view_select.select', {}, 'universal_discovery_widget');
    var changeLabel = Translator.trans(
    /*@Desc("Change content")*/
    'filters.tag_view_change.select', {}, 'universal_discovery_widget');
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", {
  ...
  /*@Desc("Filters")*/
  'filters.title', {}, 'universal_discovery_widget');
  var languageLabel = Translator.trans(
  /*@Desc("Language")*/
  'filters.language', {}, 'universal_discovery_widget');
...
var Search = function Search(_ref) {
  ...
  var renderCustomTableHeader = function renderCustomTableHeader() {
    ...
    var searchResultsTitle = Translator.trans(
    /*@Desc("Results for “%search_phrase%” (%total%)")*/
    'search.search_results', {
      search_phrase: searchText,
      total: data.count
    }, 'universal_discovery_widget');
    var searchResultsSubtitle = Translator.trans(
    /*@Desc("in %search_language%")*/
    'search.search_results.in_language', {
  ...
  var renderSearchResults = function renderSearchResults() {
    if (data.count) {
      ...
      /*@Desc("No results found for %query%")*/
      'search.no_results', {
        query: searchText
      }, 'universal_discovery_widget');
      var noResultsHints = [Translator.trans(
      /*@Desc("Check the spelling of keywords.")*/
      'search.no_results.hint.check_spelling', {}, 'universal_discovery_widget'), Translator.trans(
      /*@Desc("Try more general keywords.")*/
      'search.no_results.hint.more_general', {}, 'universal_discovery_widget'), Translator.trans(
      /*@Desc("Try different keywords.")*/
      'search.no_results.hint.different_kewords', {}, 'universal_discovery_widget'), Translator.trans(
      /*@Desc("Try fewer keywords. Reducing keywords results in more matches.")*/
      'search.no_results.hint.fewer_keywords', {}, 'universal_discovery_widget')];
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
...
var SelectedLocations = function SelectedLocations() {
  ...
  var renderSelectionCounter = function renderSelectionCounter() {
    ...
    /*@Desc("%count% selected item(s)")*/
    'selected_locations.selected_items', {
  ...
  var renderActionButtons = function renderActionButtons() {
    var removeAllLabel = Translator.trans(
    /*@Desc("Remove all")*/
    'selected_locations.remove_all', {}, 'universal_discovery_widget');
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
...
var TopMenu = function TopMenu(_ref) {
  ...
  /*@Desc("Close")*/
  'close.label', {}, 'universal_discovery_widget');
...
var ContentMetaPreview = function ContentMetaPreview() {
  ...
  var renderActions = function renderActions() {
    ...
    var bookmarksAddLabel = Translator.trans(
    /*@Desc("Add to bookmarks")*/
    'meta_preview.bookmarks_add', {}, 'universal_discovery_widget');
    var bookmarksRemoveLabel = Translator.trans(
    /*@Desc("Remove from bookmarks")*/
    'meta_preview.bookrmarks_remove', {}, 'universal_discovery_widget');
...
var SORTING_OPTIONS = [{
  ...
  /*@Desc("Date")*/
  'sorting.date.label', {}, 'universal_discovery_widget'), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_common_icon_icon__WEBPACK_IMPORTED_MODULE_2__["default"], {
    name: "back",
  ...
  /*@Desc("Sort by date")*/
  'sorting.date.selected_label', {}, 'universal_discovery_widget'), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_common_icon_icon__WEBPACK_IMPORTED_MODULE_2__["default"], {
    name: "back",
    extraClasses: "c-simple-dropdown__arrow-down ibexa-icon--tiny-small"
  })),
  ...
  label: Translator.trans(
  /*@Desc("Name A-Z")*/
  'sorting.name.asc.label', {}, 'universal_discovery_widget'),
  selectedLabel: Translator.trans(
  /*@Desc("Sort by name A-Z")*/
  'sorting.name.asc.selected_label', {}, 'universal_discovery_widget'),
  ...
  label: Translator.trans(
  /*@Desc("Name Z-A")*/
  'sorting.name.desc.label', {}, 'universal_discovery_widget'),
  selectedLabel: Translator.trans(
  /*@Desc("Sort by name Z-A")*/
  'sorting.name.desc.selected_label', {}, 'universal_discovery_widget'),
  sortClause: 'ContentName',
  sortOrder: 'descending'
}];
var VIEWS = [{
